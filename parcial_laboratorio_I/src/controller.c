...
{
	publication_force_init(listPub, lenPub, 4, PAUSED, 50, "Vendo moto");
	publication_force_init(listPub, lenPub, 5, ACTIVE, 24, "Vendo celular");
	publication_force_init(listPub, lenPub, 2, ACTIVE, 24, "Vendo computadora, buen estado");
	publication_force_init(listPub, lenPub, 3, ACTIVE, 50, "Pinto casas");
